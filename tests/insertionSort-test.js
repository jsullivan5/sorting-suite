...
describe('Insertion Sort', () => {
  ...
  it('should sort negative numbers', () => {
    ...
    expect(insertionSort(negNumArray)).to.deep.equal(sortedNegArray);
  })
  ...
  it('should sort positive and negative numbers', () => {
    ...
    expect(insertionSort(posNegArray)).to.deep.equal(sortedPosNegArray);
  })
  ...
  it('should sort large arrays of numbers', () => {
    ...
    expect(insertionSort(randomArray))
  ...
  it('should sort large arrays of characters', () => {
    ...
    expect(insertionSort(ranCharArray)).to.deep.equal(compSorted);
  })
})
