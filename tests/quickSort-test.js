...
describe('Quick Sort', () => {
  ...
  it('should sort negative numbers', () => {
    ...
    expect(quickSort(negNumArray)).to.deep.equal(sortedNegArray);
  })
  ...
  it('should sort positive and negative numbers', () => {
    ...
    expect(quickSort(posNegArray)).to.deep.equal(sortedPosNegArray);
  })
  ...
  it('should sort large arrays of characters', () => {
    ...
    expect(quickSort(ranCharArray)).to.deep.equal(compSorted);
  })
})
